...
public class Fibonacci {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("动物数量为:" + fibonacci.fib_i(1, 1, 3));
        // System.out.println("动物数量为:" + fibonacci.fib(50));//12586269025
        // System.out.println("动物数量为:" + fibonacci.fibonacciNormal(100));//12586269025
        // System.out.println("动物数量为:" + fibonacci.fibonacci(10));
