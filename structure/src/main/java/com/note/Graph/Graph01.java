...
public class Graph01 {
    public Graph.WeightManager<Double> weightManager = new Graph.WeightManager<Double>() {
     ...
     * 有向图
     */
    public Graph<Object, Double> directedGraph(Object[][] data) {
     ...
     * @return
     */
    public Graph<Object, Double> undirectedGraph(Object[][] data) {
        Graph<Object, Double> graph = new ListGraph<>(weightManager);
        for (Object[] edge : data) {
            if (edge.length == 1) {
                graph.addVertex(edge[0]);
